...
void Genetic::initialize_Population(std::vector<int> profit, std::vector<int> weight, const int addWeight)
{
...
void Genetic::run(std::vector<int> profit, std::vector<int> weight, const int addWeight)
{
...
// Individuo &Genetic::operator=(const Individuo &o)
// {
